...
ques4 = Questions(id = 4,quest = 'Swiggy most popular add-on', answer = 'ketchup')
...
ques9 = Questions(id = 9,quest = 'You only connect with IT when when something goes wrong', answer = 'zoho')
